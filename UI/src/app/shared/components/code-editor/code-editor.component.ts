...
export class CodeEditorComponent implements OnInit {
  @Input() languages: string[] = ['c', 'cpp', 'java'];
  @Input() code = '';
  @Output()
  submitCode: EventEmitter<any> = new EventEmitter<any>();
  @Input() selectedLanguage: string = this.languages[0];
  ...
  ngOnInit(): void {
    ...
    this.localCode = this.selectedLanguage;
  }
